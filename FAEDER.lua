...
name_bot = (faederdx1:get(FAEDER..'name_bot') or 'جولد')
...
faederdx113(chat,msg.id_,"*❅∫ هذا الملف ليس تابع لسورس جولد ،*")   
return false 
end      
...
keyboard = {} -- الحقوق محفوظه لسورس جولد لتخمط بدون ذكر المصدر
...
if text == 'سورس جولد' or text == 'سورس ديف جولد' or text == 'سورس انور'  then if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then faeder =  "تااج وباجج حبيي ، 😹🌝" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end 
...
if text == 'بوت' and faeder11(msg) then  name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'جولد')  local faeder = {  "أسمي "..name_bot.." يعمري ",  "أسمي "..name_bot.." يقميل ",  "تره أسمي "..name_bot.." كافي بوت ",  "انت البوت لك اسمي "..name_bot.." ", }  faeder2 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faeder2] , 1, 'md')  end
if (text and text == (faederdx1:get('faeder:'..bot_id..'name_bot') or 'جولد')) then name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'جولد') local namebot = {  'عيون '..name_bot..' العسليات ؛🤭☄',  'اطلقق من يصيح '..name_bot..' ؛😻💗',  'وياك '..name_bot..' عمري أمرني 🌾' } name = math.random(#namebot) faederdx(msg.chat_id_, msg.id_, 1, namebot[name] , 1, 'md') return false end
--     By Developer Faeder     -- 
...
name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'جولد')
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     By Developer Faeder     -- 
...
os.execute('wget https://raw.githubusercontent.com/amrjava/amr/master/FAEDER.lua') 
